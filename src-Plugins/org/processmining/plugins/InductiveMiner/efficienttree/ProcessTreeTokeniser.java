...
/**
 * The <code>StreamTokenizer</code> class takes an input stream and parses it
 ...
 * space</i>, <i>alphabetic</i>, <i>numeric</i>, <i>string quote</i>, and
 * <i>comment character</i>. Each character can have zero or more of these
 * attributes.
 * <p>
...
public class ProcessTreeTokeniser {
	...
	private ProcessTreeTokeniser() {
		// everything is a word char
		wordChars(21, Integer.MAX_VALUE);

		// space and tabs are not white spaces, but part of names
		whitespaceChars(0, 8);
		whitespaceChars(10, ' ' - 1);
		...
		// do not parse numbers specifically
		// parseNumbers();

		// a tab is semanticsful white space and we need to know it.
		wordChars('\t', '\t');
	}
	 ...
	 */
	@Deprecated
	public ProcessTreeTokeniser(InputStream is) {
		this();
		if (is == null) {
	 ...
	 * @since JDK1.1
	 */
	public ProcessTreeTokeniser(Reader r) {
		this();
		if (r == null) {
			throw new NullPointerException();
		}
	 ...
	 * treats it as a single-character token and sets <code>ttype</code> field
	 * to the character value.
	 *
	 * <p>
	 * Making a line terminator character "ordinary" may interfere with the
	 * ability of a <code>StreamTokenizer</code> to count lines. The
	 * <code>lineno</code> method may no longer reflect the presence of such
	 ...
	 * than a word, by setting the <code>ttype</code> field to the value
	 ...
	 * <code>'&#92;n'</code>). In addition, a carriage-return character followed
	 ...
	 *
	 * @param flag
	 *            <code>true</code> indicates that end-of-line characters are
	 *            separate tokens; <code>false</code> indicates that end-of-line
	 ...
	 *
	 * @param flag
	 *            <code>true</code> indicates to recognize and ignore C-style
	 *            comments.
	 */
	 ...
	 *
	 * @param fl
	 *            <code>true</code> indicates that all word tokens should be
	 *            lowercased.
	 * @see java.io.StreamTokenizer#nextToken()
	 * @see java.io.StreamTokenizer#ttype
	 * @see java.io.StreamTokenizer#TT_WORD
