 ...
 * horizontal scrollbar can be displayed when necessary - the popup can be
 * wider than the combo box - the popup can be displayed above the combo box
 *
...
public class BoundsPopupMenuListener implements PopupMenuListener {
	 ...
	 * combo box or the preferred width of the popup. Normally the popup
	 * width is always the same size as the combo box width.
	 *
	 * @param popupWider
	...
	/*
	 * This method is called every time: - to make sure the viewport is
	 * returned to its default position - to remove the horizontal scrollbar
