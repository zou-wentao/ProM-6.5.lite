...
public class ParseException extends Exception {
	...
	private static String initialise(Token currentToken, int[][] expectedTokenSequences, String[] tokenImage) {
		...
		expected.append("\n\n");
		expected.append("Expected syntax:\n");
		expected.append("	parse	:=	orExpression <EOF>\r\n"
				+ "	orExpression	:=	andExpression ( ( <OR> andExpression ) )*\r\n"
				+ "	andExpression	:=	term ( ( <AND> term ) )*\r\n"
				+ "	term	:=	simpleExpression\r\n"
				+ "		|	( <LPAREN> orExpression <RPAREN> )\r\n"
				+ "	simpleExpression	:=	( eventName <DOT> )? attributeName ( op ) value\r\n"
				+ "	eventName	:=	( <IDENTIFIER> | <STRING_LITERAL> )\r\n"
				+ "	attributeName	:=	( <IDENTIFIER> | <STRING_LITERAL> )\r\n"
				+ "	value	:=	( ( <IDENTIFIER> | <INTEGER_LITERAL> | <FLOATING_POINT_LITERAL> ) | <STRING_LITERAL> )\r\n"
				+ "	op	:=	( <EQUAL> | <CONTAINS> | <REGEX> | <NOTEQUAL> | <GT> | <LT> | <LTE> | <GTE> )");
...
/*
 * JavaCC - OriginalChecksum=7205ff0fba7a6c38e87fc16c8ec187a5 (do not edit this
 * line)
 */
